...
!    - lap2d_sprime: Given a density sigma this routine returns the 
!        solution u
!
!    - lap2d_sprime_eval: Given \sigma this routine evaluates the solution 
...
!
      ...
      subroutine getnearquad_lap2d_sprime(npatches, norders, &
...
!$OMP END PARALLEL DO      
      ...
      return
      end subroutine getnearquad_lap2d_sprime
!
!
!
!
